...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Úte 12. lis 2024, 21:08
...
--
-- Vypisuji data pro tabulku `nu`
--

INSERT INTO `nu` (`id`, `nazev`) VALUES
(1, 'Maturita Solutions (2nd Edition) Upper-Intermediate Student´s Book'),
(2, 'Matematika pro 9.r.ZŠ,1.d.-Odvárko,Kadleček');
...
(1, 1, 4, 2014, 6, 300, 5, '1', 'ošoupaná, semtam popsaná, ohlé rohy'),
(2, 1, 4, 2013, 7, 350, 0, '2', 'ošoupaná, semtam popsaná, ohlé rohy'),
(3, 1, 4, 2017, 8, 450, 0, '3', 'ošoupaná, semtam popsaná, ohlé rohy'),
(4, 1, 4, 2015, 7, 400, 0, '4', 'ošoupaná, semtam popsaná, ohlé rohy'),
(5, 2, 4, 2014, 7, 100, 0, '2', 'pěkný stav'),
(6, 2, 4, 2013, 8, 125, 1, '2', 'pěkný stav'),
(7, 2, 3, 2013, 10, 150, 0, '2', 'nová');
...
INSERT INTO `ucebnice` (`id`, `jmeno_id`, `kategorie_id`, `typ_id`, `trida_id`, `foto`, `schvaleno`) VALUES
(1, 1, 2, 1, 8, '35861.jpg', 1),
(2, 2, 1, 1, 4, '41653.jpg', 1);
